...
const Contact = () => (
  <>
    ...
    <link rel="canonical" href="https://www.concretecalculators.io/contact" />
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          ...
          <div className="surface-card p-8 flex items-center gap-4">
            ...
            <div>
              ...
              <a href="mailto:guestblogger034@gmail.com" className="text-accent hover:underline">
                guestblogger034@gmail.com
              </a>
            </div>
          </div>
